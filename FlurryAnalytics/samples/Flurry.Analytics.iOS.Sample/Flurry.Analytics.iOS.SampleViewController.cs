...
{
	public partial class Flurry_Analytics_iOS_SampleViewController : UIViewController
	{
		public Flurry_Analytics_iOS_SampleViewController (IntPtr handle) : base (handle)
		{
		}
